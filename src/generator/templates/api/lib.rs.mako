...
<%
    ...
    from generator.lib.filters import rust_comment, rust_module_doc_comment
...
<%
    from generator.lib.util import (new_context, rb_type, hub_type, hub_type_params_s,
                      rb_type_params_s, find_fattest_resource, HUB_TYPE_PARAMETERS, METHODS_RESOURCE,
                      UNUSED_TYPE_MARKER, schema_markers)
    from generator.lib.filters import rust_comment, rust_doc_comment, rust_module_doc_comment
